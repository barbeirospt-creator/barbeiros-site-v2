      ...
      <main>
        ...
        <section id="saibamais" className="section">
          <div className="container">
            ...
            <p className="sectionSub">Ferramentas poderosas desenhadas especificamente para donos de barbearias</p>

            <div className="cards3">
              <div className="card">
                <div className="cardIcon">👥</div>
                <h3>Comunidade</h3>
                <p>Conecte-se com donos de barbearias em todo Portugal. Partilhe experiências, dicas e cresçam juntos.</p>
              </div>

              <div className="card">
                <div className="cardIcon">🏪</div>
                <h3>Expor o seu Negócio</h3>
                <p>Apresente o seu negócio com fotos, portfólio, especialidades, localização e horários de funcionamento.</p>
              </div>

              <div className="card">
                <div className="cardIcon">🛒</div>
                <h3>Compras em Grupo</h3>
                <p>Junte o poder de compra com outras barbearias para obter os melhores negócios em suprimentos.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="section sectionAlt">
          <div className="container">
            ...
            <p className="sectionSub">Junte-se a centenas de donos de barbearias satisfeitos</p>

            <div className="cards3">
              <div className="testimonial">
                <div className="stars">★★★★★</div>
                <p className="quote">“O Barbeiros.pt transformou a forma como giro o meu negócio. A visibilidade que ganhei foi incrível.”</p>
              ...
              <div className="testimonial">
                <div className="stars">★★★★★</div>
                <p className="quote">“A funcionalidade de comunidade é incrível. Conectei-me com tantos profissionais e aprendi muito.”</p>
              ...
              <div className="testimonial">
                <div className="stars">★★★★★</div>
                <p className="quote">“As compras em grupo pouparam-me milhares. Esta plataforma paga-se a si mesma.”</p>
            ...
            <div className="ctaBand">
              <h3>Pronto para Transformar o Seu <span className="accent">Negócio</span>?</h3>
              <p className="muted">Junte-se ao Barbeiros.pt hoje e leve a sua barbearia ao próximo nível</p>
      ...
      <footer className="footer">
        <div className="container footerGrid">
          <div>
            ...
            <p className="muted">A plataforma premium da comunidade para barbearias portuguesas.</p>
          </div>
        ...
        <div className="container footerBottom">
          <span className="muted">© {new Date().getFullYear()} Barbeiros.pt. Todos os direitos reservados.</span>
        </div>
      </footer>
    </div>
  );
